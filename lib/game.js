  ...
  Game.prototype.update = function() {
    ...
    this.fallingObjects().slice(0).forEach(function(object) {
      ...
      if(game.isOver() && game.isWon()) {
        // eventually call finishView here, passing in win = true
        console.log('WIN');
      } else if(game.isOver()) {
        // call finish view, passing in win = false
      }
    });
  };
})(this);
...
var billLoaded = false, handLoaded = false, paperLoaded = false;

var maybeStartGame = function() {
  if(billLoaded && handLoaded && paperLoaded) {
